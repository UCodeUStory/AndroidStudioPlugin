...
public class AddMap extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                document.insertString(insertOffset, getAddMapMethod(selectedText, type));
            }
        };
    ...
    private String getAddMapMethod(String field, String type) {
      ...
      //  String setter = "\tpublic void setUpperField(TYPE FIELD){\n\t\tthis.FIELD=FIELD;\n\t}";
        ...
        String addMap = "\tpublic void addUpperFieldtoMap(Map<String,String>map){\n\t\tmap.put(\"FIELD\",this.FIELD);\n\t}";
      ...
      //  String mySetter = setter.replaceAll("TYPE", type).replaceAll("UpperField", upperField).replaceAll("FIELD", field);
        ...
        addMap = addMap.replaceAll("TYPE", type).replaceAll("UpperField", upperField).replaceAll("FIELD", field);
//        return "\n"+myGetter + "\n" + mySetter + "\n";
